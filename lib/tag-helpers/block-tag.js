  ...
  return (tag, context) => {
    ...
    const value = tag.childNodes.reduce(
      (accumulator, node) => {
        ...
        if (context.options.enableWordWrap && accumulator.inline && accumulator.inline.value != undefined) {
    ...
    if (context.options.enableWordWrap && value.inline != undefined && value.inline.value != undefined) {
